#ifndef PIXEDIT_SRC_EDITOR_APP_IMGUI_SHOW_NEW_FILE_DIALOG_INCLUDED
#define PIXEDIT_SRC_EDITOR_APP_IMGUI_SHOW_NEW_FILE_DIALOG_INCLUDED
...
#endif /* PIXEDIT_SRC_EDITOR_APP_IMGUI_SHOW_NEW_FILE_DIALOG_INCLUDED */
